...
| :--------------------------- | :------: | :--------------------------------------------------: | :-------------------------------------------------------------------- |
| API_JWKS_URI                 |    N     | `https://vitalam.eu.auth0.com/.well-known/jwks.json` | JSON Web Key Set containing public keys used by the Auth0 API         |
| API_AUTH_AUDIENCE            |    N     |                    `vitalam-test`                    | Identifier of the Auth0 API                                           |
| API_AUTH_ISSUER              |    N     |           `https://vitalam.eu.auth0.com/`            | Domain of the Auth0 API                                               |
| API_AUTH_TOKEN_URL           |    N     |      `https://vitalam.eu.auth0.com/oauth/token`      | Auth0 API endpoint that issues an Authorisation (Bearer) access token |
